                    ...
                    double& totalAvgErr)
{
    ...
    cameraMatrix.at<double>(0, 0) = 1920.0/1;
    cameraMatrix.at<double>(1, 1) = 1440.0/1;
    cameraMatrix.at<double>(0, 2) = 1920.0/2;
    cameraMatrix.at<double>(1, 2) = 1440.0/2;
    std::cerr << cameraMatrix << "\n";
